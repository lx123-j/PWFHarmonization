...
###############################################################################
# Functions  损失函数 初始化 上采样 下采样 残差网络 鉴别器判定
###############################################################################
...
def print_network(net):
    ...
    # input = torch.randn(9, 1, 256, 256).cuda()
    # # flops, params = profile(net, inputs=(19,1,256,256))
    #
    # f1 = FlopCountAnalysis(net, input)
    # print('FLOPs = ' + str(f1.total() / 1000 ** 3) + 'G')
    print(net)
