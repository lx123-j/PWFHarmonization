...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--resize_mode', type=str, default='square', help='')
        self.parser.add_argument('--crop_mode', type=str, default='none', help='')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='ADNI',
                                 help='chooses how datasets are loaded.')
        self.parser.add_argument('--model', type=str, default='pwfharmonization',
        ...
        self.parser.add_argument('--adversarial_loss_p', type=int, default=1)
