...
class UnalignedScaleDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.A_paths = make_dataset(self.dir_A)        # 遍历文件夹
    ...
    def __getitem__(self, index):
        A_path = self.A_paths[index % self.A_size]      # 看起来这里的值是随机给的
        ...
        return {'A1': A_img, 'B1': B_img, 'A_paths': A_path, 'B_paths': B_path}    # 这里是图片的名字‘A1’‘B’的选择 由index传入
